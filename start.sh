...
echo "**        Copyright 2009-2014:       CSU_YUNLU                 **"
echo "**                                                             **"
echo "*****************************************************************"
echo "*****************************************************************"
sleep 0.2
...
java -Xms4g -Xmx8g -server -cp $TEAM_CP csu.LaunchAgents csu.agent.fb.FireBrigadeAgent*$1 csu.agent.fb.FireStationAgent*$2 csu.agent.pf.PoliceForceAgent*$3 csu.agent.pf.PoliceOfficeAgent*$4 csu.agent.at.AmbulanceTeamAgent*$5 csu.agent.at.AmbulanceCentreAgent*$6 -h $7 --loadabletypes.inspect.dir=jars --random.seed=1 | tee $DIR/test/sample-out.log
