...
/* ----------------------------------------- update and merge --------------------------------------------- */
	...
	/**
	 * Determines whether an entity in a building.
	 * 
	 * @param entityUrn
	 ...
	 * 
	 * @param building
	 *            the target building currently within the eyeside of this
	 *            FireBrigade Agent
	 */
...
//    }
	 ...
	 * smaller than the real dimention. But it can save lots of computing time.
	 */
...
/* ------------------------------------------- CSUBuilding part -------------------------------------------- */
	...
	/**
	 * Create {@link CSUBuilding} object for this world mdel.
	 */
