...
public abstract class ClusterManager<subCluster extends Cluster> {
	...
	/**
	 * A map stores entity and subCluster paris.
	 */
	 ...
	 * <pre>
	 * 1.Get all entities this subCluster care about, and check the menbership
	 * of those entities.
	 * 
	 * 2.If the entity can't be put into this subCluster currently, check
	 * whether it is previously in a subCluster. If ture, remove it from its
	...
	/**
	 * Find mutual entities of two clusters. The mutualed entities should be
	 ...
	 * @param ig
	 *            a set of mutualed border entities which should be ignored
	 */
	 ...
	 * @param entity
	 *            the entitiy this newly created subCluster contains
	 */
