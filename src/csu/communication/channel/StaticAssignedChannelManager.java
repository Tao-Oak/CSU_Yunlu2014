...
/**
 * This class used to get assigned channel for each type of Agent. Because there
 * is only one voice channel, and each Agent will subscribe to it. What I has
 * done is this class is assign radio channel for each type of Agent and provide
 * methods to get those assigned channels.
 * 
